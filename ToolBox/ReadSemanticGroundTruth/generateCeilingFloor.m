...
function [ gridCatLabel, gridInstLabel ] = generateCeilingFloor( path, id, sizeR, voxUnit, voxOriginWorld, gridPtsWorld, gridPtsWorldX, gridPtsWorldZ, gridCatLabel, gridInstLabel, withInstance)
